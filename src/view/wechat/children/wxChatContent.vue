<template>
  <div class="chat-session-body">
    ...
    <div class="chat-session-body-bd" ref="chatContent">
          ...
          <div class="clearfix">
            <div :class="['message-item', item.FromUserName !== loginWxUserInfo.User.UserName?'you':'me']">
              ...
              <div class="chatcontent">
                <div class="bubble" :style="{backgroundColor: item.FromUserName !== loginWxUserInfo.User.UserName?'#DCDCE0':'#6387FF', color: item.FromUserName !== loginWxUserInfo.User.UserName?'#000':'#fff'}">
      ...
      .me {
        .bubble {
          &:after {
            ...
            border-style: solid;
            border-color: transparent transparent transparent #6387FF;
          }
        }
        .avatar{
          float: right;
      ...
      .you {
        .bubble {
          &:before {
            ...
            border-style: solid;
            border-color: transparent #DCDCE0 transparent transparent;
          }
        }
      }
      &-item {
